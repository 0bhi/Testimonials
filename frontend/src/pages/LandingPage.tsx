        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl lg:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
              ...
              That's why we created Testimonial! In just minutes, you can easily
              collect text and video testimonials from your customers—no
              developers or website hosting required.
            </p>
          ...
          <div className="text-center mb-16">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
              ...
              <p className="text-gray-400 text-lg mb-6">Nobody 😂</p>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl lg:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
              ...
              (👉 full version) on your website. It's compatible with all
              no-code platforms like Webflow, WordPress, and more!
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-400">
                  Set up your testimonial collection in minutes, not hours.
                </p>
              </div>
